...
var SekindoClientDetections_URL = function (config) {
	...
	if (this.isPlayerApiActions && !this.isAmpProject && !this.isAmpIframe && !this.isApp) this.playerApiActions();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=113501&schain=1.0,1!theadengine.com,1345,1&cbuster=1690364602',
					origQString: 's=113501&schain=1.0,1!theadengine.com,1345,1',
					placementId: 113501,
					x: 600,
					y: 400,
					videoType: 'flow',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"115.0.0.0","browserVersionMajor":"115","browserVersionMinor":"0","chromeVersion":"115"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop","languages":{"0":"en","2":"es"},"googlePSI":false},
					isFpCookie: 0,
					geo: 'MX',
					dmaCode: 0,
					dynamicSetup: [],
